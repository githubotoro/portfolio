	...
	return (
		...
		>
			<div className="flex flex-row items-center place-content-center">
				<span className="blur-[0.1rem]">I</span>&nbsp;
				<span className="text-isWhite">ship</span>
				<span
					className={clsx(
						"relative overflow-hidden w-[2.3rem] h-[3.2rem] md:w-[4.3rem] md:h-[6.2rem] mx-2 md:mx-5 rounded-lg md:rounded-2xl hover:scale-[1.5] hover:-rotate-6 group object-bottom",
						ANIMATE
					)}
				>
					<Image
			...
			<div className="flex flex-row items-center place-content-center md:!mt-[1.6rem]">
				...
				<span className="blur-[0.1rem]">the localhost</span>
			</div>
